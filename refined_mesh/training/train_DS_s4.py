...
Example:
    python train_DS_s4d.py --data data/vdp_mu.npz --epochs 50 --batch_size 128 --d_model 128 --n_layers 4
"""
...
def main():
    p = argparse.ArgumentParser(description="Train S4D on dynamical systems data.")
